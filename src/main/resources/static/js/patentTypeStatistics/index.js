...
function pjsj(obj){
    if(obj.applyAuthorization.search('申请') != -1){
        ...
        $('#table_data_a').find('th').each(function(index,e){
            if($(e).text() == obj.patentTypes){
                i = 1;
                $('#table_data_b').find('td').eq(index).text(Number($('#table_data_b').find('td').eq(index).text())+Number(1));
            }
        });
        if(i == 0){
            $('#table_data_a').append('<th style="text-align:center;" class="table_data_data">'+obj.patentTypes+'</th>');
    ...
    if(obj.applyAuthorization.search('授权') != -1){
        ...
        if(i == 0){
            $('#table_data2_a').append('<th style="text-align:center;" class="table_data_data">'+obj.patentTypes+'</th>');
    ...
    if(obj.applyAuthorization.search('有效') != -1){
            ...
            if(i == 0){
                $('#table_data3_a').append('<th style="text-align:center;" class="table_data_data">'+obj.patentTypes+'</th>');
