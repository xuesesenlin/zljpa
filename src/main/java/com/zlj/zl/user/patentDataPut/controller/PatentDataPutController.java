package com.zlj.zl.user.patentDataPut.controller;
 ...
 */
@RestController
@RequestMapping("/patentDataPut")
public class PatentDataPutController {
    ...
    public ModelAndView page() {
        return new ModelAndView("/patentDataPut/index");
    }

    @RequestMapping(value = "/patentDataPut/{pageNow}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/patentDataPut", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/patentDataPut/{id}", method = RequestMethod.DELETE)
    public ResponseResult<PatentDataPutModel> findByArea(@PathVariable("id") String id) {
...
//            组装excel
    ...
    public ResponseResult<PatentDataPutModel> delete_export(@ModelAttribute(value = "form") PatentDataPutQueryModel model,
                                                            HttpServletResponse response) {
        ResponseResult<List<PatentDataPutModel>> result = service.list(model);
        if (result.isSuccess())
            return service.updates(result.getData(), 1);
        else
