package com.zlj.zl.user.xlsjtj.controller;
 ...
 */
@RestController
@RequestMapping("/xlsjtj")
public class XlsjtjController {
    ...
    public ModelAndView page() {
        return new ModelAndView("/xlsjtj/index");
    }

    @RequestMapping(value = "/xlsjtj/{pageNow}", method = RequestMethod.GET)
