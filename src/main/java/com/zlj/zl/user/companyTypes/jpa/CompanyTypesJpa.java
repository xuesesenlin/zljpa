package com.zlj.zl.user.companyTypes.jpa;
 ...
 * @remarks
 */
public interface CompanyTypesJpa extends JpaSpecificationExecutor<CompanyTypesModel>,
        JpaRepository<CompanyTypesModel, String> {

    List<CompanyTypesModel> findByCompanyTypes(String companyTypes);
