package com.zlj.zl.user.xlsjcx.controller;
 ...
 */
@RestController
@RequestMapping("/xlsjcx")
public class XlsjcxController {
    ...
    public ModelAndView page() {
        return new ModelAndView("/xlsjcx/index");
    }

    @RequestMapping(value = "/xlsjcx/{pageNow}", method = RequestMethod.GET)
